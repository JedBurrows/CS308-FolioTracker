...
public class StrathQuoteServer implements IQuoteServer {
    ...
    private static final String _URL = "http://www.tickertech.com/cgi/?ticker=";

    private static final String _TOKEN1a = "ticker=";

    private static final String _TOKEN1b = "&a=detailed";

    private static String _TOKEN1 = "";

    @Override
    public double getStockPrice(String tickerSymbol) throws NoSuchTickerException, WebsiteDataException {
        return Double.valueOf(getLastValue(tickerSymbol));
    }

    @Override
    public boolean isValidStockTicker(String tickerSymbol) {
        try {
            getLastValue(tickerSymbol);
     ...
     * <br>
     */
    private String getLastValue(String tickerSymbol)
